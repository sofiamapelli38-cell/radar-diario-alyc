...
- Incluí como máximo cinco novedades realmente útiles.
- Excluí traducciones, publicidad y contenido institucional sin impacto concreto.
- Resumí cada novedad en hasta tres líneas: qué pasó, por qué importa y qué conviene hacer.

## 5. Formato de salida obligatorio

Enviá HTML real (text/html; charset=UTF-8), sin Markdown visible, con estilos inline compatibles con Gmail y ancho máximo de 900 px.

1. Encabezado con nombre y fecha.
2. Resumen ejecutivo breve.
3. Tabla de hasta seis columnas: Fecha y fuente, Novedad, Clasificación, Prioridad, Acción sugerida y Enlace.
4. Control de calidad.
5. Datos de corrida y supervisión.

Usá 🔴 ALTA, 🟡 MEDIA y 🟢 BAJA. Cada hallazgo debe tener un enlace clicable “Abrir fuente”. Si no hay hallazgos, enviá un recuadro breve sin tabla vacía.

## 6. Ejemplos

Incluí una novedad verificable y relevante con enlace directo. Excluí movimientos generales de mercado sin impacto concreto.